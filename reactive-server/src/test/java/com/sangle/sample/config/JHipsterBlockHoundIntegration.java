package com.sangle.sample.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.sangle.sample.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.sangle.sample.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
