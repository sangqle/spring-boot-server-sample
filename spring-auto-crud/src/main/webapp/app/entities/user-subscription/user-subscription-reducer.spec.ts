...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './user-subscription.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERSUBSCRIPTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERSUBSCRIPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERSUBSCRIPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERSUBSCRIPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERSUBSCRIPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERSUBSCRIPTION actions', async () => {
      const expectedActions = [
        {
