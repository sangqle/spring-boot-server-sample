...
import { getEntity, deleteEntity } from './user-subscription.reducer';

export const UserSubscriptionDeleteDialog = () => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(userSubscriptionEntity.id));
  };

  return (
    <Modal isOpen toggle={handleClose}>
      <ModalHeader toggle={handleClose} data-cy="userSubscriptionDeleteDialogHeading">
        Confirm delete operation
      </ModalHeader>
      <ModalBody id="springAutoCrudApp.userSubscription.delete.question">
        Are you sure you want to delete User Subscription {userSubscriptionEntity.id}?
      </ModalBody>
      <ModalFooter>
...
export default UserSubscriptionDeleteDialog;
