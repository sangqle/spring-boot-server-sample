...
export const Pricing = () => {
  ...
  const totalItems = useAppSelector(state => state.pricing.totalItems);
  ...
  return (
    <div>
            ...
            <tbody>
              {pricingList.map((pricing, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{pricing.desc}</td>
                  <td>{pricing.price}</td>
                  <td>{pricing.updatedAt ? <TextFormat type="date" value={pricing.updatedAt} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{pricing.isDeleted ? 'true' : 'false'}</td>
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`/pricing/${pricing.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      ...
                      <Button
                        tag={Link}
                        to={`/pricing/${pricing.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
      ...
      {totalItems ? (
        <div className={pricingList && pricingList.length > 0 ? '' : 'd-none'}>
